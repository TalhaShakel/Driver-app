...
class AssistantMethods
{
  ...
  static double calculateFareAmountFromOriginToDestination(DirectionDetailsInfo directionDetailsInfo)
  {
    ...
    if(driverVehicleType == "bike")
      {
        double resultFrameAmount = (totalFareAmount.truncate()) / 2.0;
        return resultFrameAmount;
      }
    else if(driverVehicleType == "oasis-go")
    {
      return totalFareAmount.truncate().toDouble();
    }
    else if(driverVehicleType == "oasis-x")
    {
      double resultFrameAmount = (totalFareAmount.truncate()) * 2.0;
      return resultFrameAmount;
    }
  ...
  static void readDriverEarnings(context)
  {
        ...
        .then((snap)
    {
      if(snap.snapshot.value != null)
      {
        ...
        Provider.of(context, listen: false).updateDriverTotalEarnings(driverEarnings);
      }
    });
  ...
  static void readDriverRatings(context)
  {
        ...
        .then((snap)
    {
      if(snap.snapshot.value != null)
      {
        ...
        Provider.of(context, listen: false).updateDriverAverageRatings(driverRatings);
      }
    });
  }
